...
Note: Use a MongoDB aggregation query with the pipeline feature. The template engine to be used is EJS. Also, category and subcategory should be in a single collection called